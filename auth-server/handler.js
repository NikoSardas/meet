...
const credentials = {
  ...
  redirect_uris: ["https://NikoSardas.github.io/meet/"],
  javascript_origins: ["https://NikoSardas.github.io", "http://localhost:3000"],
};
const {
  client_secret,
  client_id,
...
module.exports.getAuthURL = async () => {
  const authUrl = oAuth2Client.generateAuthUrl({ // no await?
    access_type: "offline",
    scope: SCOPES,
  });
